...
- **Social-ready timelapse** — pick an aspect ratio (9:16 Reels/Stories, 4:5 IG feed, 1:1, or native) for the compiled timelapse, with a blurred-fill / letterbox / crop mode and an optional burn-in caption (print time, filament, date). The live view and AI detection always use the full frame. All in the ⚙ settings panel
